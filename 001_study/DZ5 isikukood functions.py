...
def print_gender():
    if id_code[0] in ['0', '9']:
        print('Gender can not be determined')
    else:
...
def print_dob():
    ...
    if bcent:
        ...
        print(f'Something is wrong with your ID.')
...
#If statement to get region of birth
    if int(id_code[7:10]) in range(1, 11):
        ...
        bregion = None
    if bregion:
        print(f'You were born {bregion}.')
    else:
        print(f'Can not determined where you were borned.')
